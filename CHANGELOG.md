...
## [2.1.5](https://github.com/onos9/postal/compare/v2.1.4...2.1.5) (2023-09-24)


### Bug Fixes

* duplicate string before modifying it to prevent frozen string errors ([f0a8aca](https://github.com/onos9/postal/commit/f0a8aca6e10064fb16daefff9e22dcc20a831868))
* fixed typo (rfc number) ([2f62baa](https://github.com/onos9/postal/commit/2f62baa238fc1102706ee4acf079b7a876b05283))
* match IPv4 mapped IPv6 addresses when searching for SMTP-IP credentials ([8b525d0](https://github.com/onos9/postal/commit/8b525d0381a9e0113af808b9ec2eb47bf78ec60b))
